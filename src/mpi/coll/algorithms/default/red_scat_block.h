...
#ifndef MPIC_DEFAULT_REDSCAT_BLOCK_H
#define MPIC_DEFAULT_REDSCAT_BLOCK_H
...
MPIC_INLINE int MPIC_DEFAULT_Reduce_scatter_block_noncomm(const void *sendbuf,
                                                          void *recvbuf,
                                                          int recvcount,
...
MPIC_INLINE int MPIC_DEFAULT_Reduce_scatter_block_intra(const void *sendbuf,
                                                        void *recvbuf,
                                                        int recvcount,
                                                        MPI_Datatype datatype,
                                                        MPI_Op op,
...
/* not declared static because a machine-specific function may call this one in some cases */
MPIC_INLINE int MPIC_DEFAULT_Reduce_scatter_block_inter(const void *sendbuf,
                                                        void *recvbuf,
                                                        int recvcount,
                                                        MPI_Datatype datatype,
                                                        MPI_Op op,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Reduce_scatter_block(const void *sendbuf, void *recvbuf,
