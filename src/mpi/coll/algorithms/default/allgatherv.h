...
#ifndef MPIC_DEFAULT_ALLGATHERV_H
#define MPIC_DEFAULT_ALLGATHERV_H
/*
...
MPIC_INLINE int MPIC_DEFAULT_Allgatherv_intra(const void *sendbuf,
                                              int sendcount,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Allgatherv_inter(const void *sendbuf,
                                              int sendcount,
                                              MPI_Datatype sendtype,
                                              void *recvbuf,
                                              const int *recvcounts,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Allgatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
