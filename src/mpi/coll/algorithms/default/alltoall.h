...
#ifndef MPIC_DEFAULT_ALLTOALL_H
#define MPIC_DEFAULT_ALLTOALL_H
...
MPIC_INLINE int MPIC_DEFAULT_Alltoall_intra(const void *sendbuf,
                                            int sendcount,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Alltoall_inter(const void *sendbuf,
                                            int sendcount,
                                            MPI_Datatype sendtype,
                                            void *recvbuf,
                                            int recvcount,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Alltoall(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
