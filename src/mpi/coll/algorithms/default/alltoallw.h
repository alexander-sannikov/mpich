...
#ifndef MPIC_DEFAULT_ALLTOALLW
#define MPIC_DEFAULT_ALLTOALLW
...
MPIC_INLINE int MPIC_DEFAULT_Alltoallw_intra(const void *sendbuf, const int sendcounts[],
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Alltoallw_inter(const void *sendbuf, const int sendcounts[],
                                             const int sdispls[], const MPI_Datatype sendtypes[],
                                             void *recvbuf, const int recvcounts[],
                                             const int rdispls[], const MPI_Datatype recvtypes[],
                                             MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Alltoallw(const void *sendbuf, const int sendcounts[],
                                       const int sdispls[], const MPI_Datatype sendtypes[],
