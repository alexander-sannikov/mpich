...
#ifndef MPIC_DEFAULT_REDUCE_H
#define MPIC_DEFAULT_REDUCE_H
...
MPIC_INLINE int MPIC_DEFAULT_Reduce_binomial(const void *sendbuf,
                                             void *recvbuf,
                                             int count,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Reduce_redscat_gather(const void *sendbuf,
                                                   void *recvbuf,
                                                   int count,
                                                   MPI_Datatype datatype,
                                                   MPI_Op op,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Reduce_intra(const void *sendbuf,
                                          void *recvbuf,
                                          int count,
                                          MPI_Datatype datatype,
                                          MPI_Op op,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Reduce_inter(const void *sendbuf,
                                          void *recvbuf,
                                          int count,
                                          MPI_Datatype datatype,
                                          MPI_Op op,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Reduce(const void *sendbuf, void *recvbuf, int count,
