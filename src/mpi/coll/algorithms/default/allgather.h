...
#ifndef MPIC_DEFAULT_ALLGATHER_H
#define MPIC_DEFAULT_ALLGATHER_H
...
MPIC_INLINE int MPIC_DEFAULT_Allgather_intra(const void *sendbuf,
                                             int sendcount,
...
/* not declared static because a machine-specific function may call this one
   in some cases */
MPIC_INLINE int MPIC_DEFAULT_Allgather_inter(const void *sendbuf,
                                             int sendcount,
                                             MPI_Datatype sendtype,
                                             void *recvbuf,
                                             int recvcount,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Allgather(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
