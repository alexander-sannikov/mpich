...
#ifndef MPIC_DEFAULT_ALLTOALLV
#define MPIC_DEFAULT_ALLTOALLV
...
MPIC_INLINE int MPIC_DEFAULT_Alltoallv_intra(const void *sendbuf, const int *sendcounts,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Alltoallv_inter(const void *sendbuf, const int *sendcounts,
                                             const int *sdispls, MPI_Datatype sendtype,
                                             void *recvbuf, const int *recvcounts,
                                             const int *rdispls, MPI_Datatype recvtype,
                                             MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Alltoallv(const void *sendbuf, const int *sendcounts,
