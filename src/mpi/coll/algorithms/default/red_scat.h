...
#ifndef MPIC_DEFAULT_REDSCAT_H
#define MPIC_DEFAULT_REDSCAT_H
...
MPIC_INLINE int MPIC_DEFAULT_Reduce_scatter_noncomm(const void *sendbuf, void *recvbuf,
...
MPIC_INLINE int MPIC_DEFAULT_Reduce_scatter_intra(const void *sendbuf, void *recvbuf,
                                                  const int recvcounts[], MPI_Datatype datatype,
                                                  MPI_Op op, MPIR_Comm * comm_ptr,
                                                  MPIR_Errflag_t * errflag)
{
...
/* not declared static because a machine-specific function may call this one in some cases */
MPIC_INLINE int MPIC_DEFAULT_Reduce_scatter_inter(const void *sendbuf, void *recvbuf,
                                                  const int recvcounts[], MPI_Datatype datatype,
                                                  MPI_Op op, MPIR_Comm * comm_ptr,
                                                  MPIR_Errflag_t * errflag)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Reduce_scatter(const void *sendbuf, void *recvbuf,
                                            const int recvcounts[], MPI_Datatype datatype,
                                            MPI_Op op, MPIR_Comm * comm_ptr,
                                            MPIR_Errflag_t * errflag)
{
