...
#ifndef MPIC_DEFAULT_BCAST_H
#define MPIC_DEFAULT_BCAST_H
/*
...
MPIC_INLINE int MPIC_DEFAULT_Bcast_binomial(void *buffer,
                                            int count,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int scatter_for_bcast(void *buffer ATTRIBUTE((unused)),
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Bcast_scatter_doubling_allgather(void *buffer,
                                                              int count,
                                                              MPI_Datatype datatype,
                                                              int root,
                                                              MPIR_Comm * comm_ptr,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Bcast_scatter_ring_allgather(void *buffer,
                                                          int count,
                                                          MPI_Datatype datatype,
                                                          int root,
                                                          MPIR_Comm * comm_ptr,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_SMP_Bcast(void *buffer,
                                       int count,
                                       MPI_Datatype datatype,
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Bcast_intra(void *buffer,
                                         int count,
                                         MPI_Datatype datatype,
                                         int root, MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Bcast_inter(void *buffer,
                                         int count,
                                         MPI_Datatype datatype,
                                         int root, MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
...
#undef FCNAME
#define FCNAME MPL_QUOTE(FUNCNAME)
MPIC_INLINE int MPIC_DEFAULT_Bcast(void *buffer, int count, MPI_Datatype datatype, int root,
                                   MPIR_Comm * comm_ptr, MPIR_Errflag_t * errflag)
{
    int mpi_errno = MPI_SUCCESS;
